...
//                    pay.AddRequestData("vnp_Amount", ((int)payment.Amount!.Value * 100).ToString()); // Số tiền cần thanh toán
...
//                var enrollment = await context.Enrollments.FirstOrDefaultAsync(e => e.Id == payment.EnrollmentId);
//                if (enrollment != null)
//                {
