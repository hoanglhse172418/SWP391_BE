...
namespace SWP391.backend.services
{
    public class SVnpay
    {
        ...
        public SortedList<string, string> RequestData => _requestData; // Thêm thuộc tính này
        ...
        public string CreateRequestUrl(string baseUrl, string vnp_HashSecret)
        {
            ...
            // Kết hợp base URL với chuỗi truy vấn và chữ ký an toàn
            string fullUrl = $"{baseUrl}?{queryString}&vnp_SecureHash={vnp_SecureHash}";

            return fullUrl; // Trả về URL hoàn chỉnh
        }
